...
export function Hero({ onReadManifesto }: HeroProps) {
  return (
    <section className="bg-black text-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-32 lg:py-40">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-20 items-start">
          <div className="space-y-8 max-w-2xl">
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl sm:text-2xl text-zinc-300 leading-relaxed max-w-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
              ...
              {onReadManifesto ? (
                <button
                  ...
                  className="inline-flex items-center justify-center px-8 py-3 border border-white/10 text-white/70 font-medium tracking-tight hover:text-white hover:border-white/20 transition-colors"
                >
                  Read the manifesto
                </button>
              ) : (
          ...
          <div className="w-full max-w-md lg:mt-12">
            <div className="bg-zinc-900 border border-white/10 p-8 space-y-6">
              <div className="text-xs uppercase tracking-[0.3em] text-zinc-500">Example thread</div>
              <div className="space-y-5">
                {[
                  ...
                  <div key={item.name} className="border-t border-white/5 pt-5 first:border-t-0 first:pt-0">
                    <div className="text-xs uppercase tracking-[0.25em] text-zinc-500 mb-2">{item.detail}</div>
                    <p className="text-sm font-medium text-white mb-2">{item.name}</p>
                    <p className="text-sm text-zinc-400 leading-relaxed">{item.note}</p>
                  </div>
                ))}
              </div>
              <div className="text-xs text-zinc-600 uppercase tracking-[0.4em] pt-4 border-t border-white/5">
