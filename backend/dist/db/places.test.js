...
async function exampleUsage() {
    try {
        ...
        const placeId1 = await (0, places_1.upsertPlace)({
        ...
        const placeId2 = await (0, places_1.upsertPlace)({
            google_place_id: 'ChIJN1t_tDeuEmsRUsoyG83frY4',
            name: 'Sydney Opera House',
            address: 'Bennelong Point, Sydney NSW 2000, Australia',
            lat: -33.8568,
        ...
        const placeId3 = await (0, places_1.upsertPlace)({
        ...
        const place = await (0, places_1.getPlaceById)(placeId1);
        console.log('Retrieved place:', place);
        // Example 5: Get place by Google Place ID
        const placeByGoogleId = await (0, places_1.getPlaceByGoogleId)('ChIJN1t_tDeuEmsRUsoyG83frY4');
        console.log('Retrieved place by Google ID:', placeByGoogleId);
        // Example 6: Search places nearby
        const nearbyPlaces = await (0, places_1.searchPlacesNearby)(-33.8568, 151.2153, 1000, 10);
