...
exports.ORDER_BY_CLAUSE = exports.BLOCK_FILTER_WHERE_CLAUSE = exports.VISIBILITY_WHERE_CLAUSE = exports.USER_FOLLOWS_WHERE_CLAUSE = exports.COMMON_FEED_JOINS = exports.COMMON_FEED_COLUMNS = void 0;
exports.buildFeedQuery = buildFeedQuery;
exports.COMMON_FEED_COLUMNS = `
...
`;
exports.USER_FOLLOWS_WHERE_CLAUSE = `
  WHERE r.user_id IN (
...
`;
exports.VISIBILITY_WHERE_CLAUSE = `
  AND r.visibility IN ('public', 'friends')
`;
exports.BLOCK_FILTER_WHERE_CLAUSE = `
  AND NOT EXISTS (
...
`;
exports.ORDER_BY_CLAUSE = `
  ORDER BY r.created_at DESC
`;
/**
 * Build a complete feed query with common fragments
 */
function buildFeedQuery(additionalWhereClause = '', additionalJoins = '', limit = 20) {
    return `
    SELECT ${exports.COMMON_FEED_COLUMNS}
    ${exports.COMMON_FEED_JOINS}
    ${additionalJoins}
    ${exports.USER_FOLLOWS_WHERE_CLAUSE}
    ${exports.VISIBILITY_WHERE_CLAUSE}
 ...
 */
function getParamCount(additionalWhereClause, additionalJoins) {
