...
exports.areNamesLikelySame = areNamesLikelySame;
exports.generateNameVariations = generateNameVariations;
exports.extractServiceType = extractServiceType;
 ...
 */
function areNamesLikelySame(name1, name2) {
    if (!name1 || !name2) {
 ...
 */
function extractServiceType(nameOrText, businessNameOrEmpty) {
